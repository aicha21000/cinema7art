...
function AdminAddActor() {
    ...
    const handleAwardChange = (index, field, value) => {
        const newAwards = [...actor.awards];
        newAwards[index] = { ...newAwards[index], [field]: value };
        setActor({ ...actor, awards: newAwards });
    };

    const handleAwardRemove = (index) => {
        setActor({
            ...actor,
            awards: actor.awards.filter((_, i) => i !== index)
        });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(error.response?.data?.message || 'حدث خطأ في إضافة الممثل');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-6">إضافة ممثل جديد</h1>
