        ...
        const fetchData = async () => {
            try {
                const [movieData, relatedData] = await Promise.all([
                    movieService.getMovie(decodeURIComponent(title)),
                    movieService.getRelatedMovies(decodeURIComponent(title))
                ]);
                setMovie(movieData);
    ...
    return (
        <>
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                <article>
                    <h1 className="text-3xl font-bold">{movie.arabicTitle}</h1>
                    <section>
