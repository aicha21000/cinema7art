...
import ActorSocial from '../components/ActorSocial';
        ...
        <div className="max-w-6xl mx-auto space-y-8">
            <div className="md:flex gap-8">
                <div className="md:w-1/3">
                    ...
                    <ActorSocial socialMedia={actor.socialMedia} />
                </div>
            ...
            {/* Films de l'acteur */}
            {actor.movies?.length > 0 && <ActorMovies movies={actor.movies} />}

            {/* Prix et récompenses */}
            {actor.awards?.length > 0 && <ActorAwards awards={actor.awards} />}
        </div>
    );
}
