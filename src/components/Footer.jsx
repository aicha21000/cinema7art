...
export default function Footer() {
    ...
    const sections = [
        ...
        },
        {
            title: 'تصنيفات',
            links: [
                { label: 'أفلام أكشن', path: '/movies?genre=action' },
                { label: 'أفلام دراما', path: '/movies?genre=drama' },
                { label: 'أفلام كوميديا', path: '/movies?genre=comedy' },
                { label: 'أفلام رعب', path: '/movies?genre=horror' }
            ]
        },
        {
            title: 'معلومات',
        ...
        <footer className="bg-black text-white py-8">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mt-8 text-sm text-gray-400">
                    <p> {currentYear} © 1 جميع الحقوق محفوظة</p>
                </div>
            </div>
        </footer>
    );
